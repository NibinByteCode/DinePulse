  ...
  return (
    <main className='main-container'>
        ...
        <div className='main-cards'>            
            <div className='card'>
                <div className='card-inner'>
                    <img src={orderrecieved_icon} alt="Dinepulse logo" className='orders_icon' />
            ...
            <div className='card'>
                <div className='card-inner'>
                    <img src={orderdelivered_icon} alt="Dinepulse logo" className='orders_icon' />
            ...
            <div className='card'>
                <div className='card-inner'>
                    <img src={orderpending_icon} alt="Dinepulse logo" className='orders_icon' />
                    <h3>ORDER PENDING</h3>                   
                    <h1>33</h1>
                </div>
            </div>
            <div className='card'>
                <div className='card-inner'>
                    <img src={netrevenue_icon} alt="Dinepulse logo" className='orders_icon' />
                    <h3>NET REVENUE</h3>
                    <h1>$420000</h1>
                </div>
            </div>
        ...
        <div className='display_recentorders'>
            <br/><h4 className='tagname'>Recent Orders</h4> <br/>          
